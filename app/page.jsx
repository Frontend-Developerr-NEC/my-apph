    ...
    <>
      <section className={s.programmingLanguage}>
        <div className={s.ReactWrapper}>
          ...
          <a href="https://react.dev/" target="_new">Visit React</a>
        </div>
        ...
        <div className={s.NextjstWrapper}>
          ...
          <a href="https://nextjs.org/" target="_new">Visit Next.JS</a>
        </div>
        ...
        <div className={s.GithubtWrapper}>
          ...
          <a href="https://github.com/" target="_new">Visit Github</a>
        </div>
        ...
        <div className={s.VercelWrapper}>
          ...
          <a href="https://vercel.com/" target="_new">Visit Vercel</a>
        </div>
      </section>
    </>
  );
